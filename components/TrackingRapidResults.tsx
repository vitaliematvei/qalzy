...
import { TrackingRapidResultsData } from '../app/data';
const { title, description, youtubeVideoId } = TrackingRapidResultsData;

export default function TrackingRapidResults() {
  const opts = {
    height: '480',
    width: '100%',
    playerVars: {
